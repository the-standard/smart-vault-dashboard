export const abi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_smartVaultDeployer", type: "address" },
      { internalType: "address", name: "_smartVaultIndex", type: "address" },
      {
        internalType: "address",
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "mintFeeRate", type: "uint256" },
          { internalType: "uint256", name: "burnFeeRate", type: "uint256" },
          {
            components: [
              {
                internalType: "address",
